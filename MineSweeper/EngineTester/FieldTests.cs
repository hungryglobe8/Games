...
namespace EngineTester
{
    ...
    public class FieldTests
    {
        ...
        public void FlagTile()
        {
            ...
            sut.Flag(tile);
            Assert.AreEqual(1, sut.NumFlagsLeft);
        }
        ...
        public void FlagTileTwice()
        {
            ...
            sut.Flag(tile);
            sut.Flag(tile);
            Assert.AreEqual(2, sut.NumFlagsLeft);
        }
        ...
        public void FlagAll()
        {
            ...
            Assert.AreEqual(0, sut.NumFlagsLeft);
